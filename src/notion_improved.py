...
class NotionPDF(FPDF):
    ...
    def detailed_tickets_table(self, tickets):
        """
        ...
        for t in tickets:
            key = t.get("key", "PD-132")
            summary = t.get("summary", "Example Summary")
            ...
            component = t.get("component", "Strategical")
            category = t.get("category", "committed")
